...
class GridBendaUji(wx.Panel):
    def __init__(self, parent):
        ...
        sizerFlexSort.Add(self.tglAkhir, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        ...
        sizerFlexSort.Add(
            self.btnCari, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT, 5
        )

        sizerBoxUtama.Add(sizerFlexSort, 0, wx.EXPAND | wx.ALIGN_CENTER_HORIZONTAL, 5)
